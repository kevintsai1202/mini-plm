...
@NoArgsConstructor
@Entity
@ToString(exclude = {"configTableHeader"})
@Table(name = "MP_TABLE_DATA")
@SQLDelete(sql = "UPDATE MP_TABLE_DATA SET enabled=0 WHERE id=?")
...
//    @ElementCollection
    ...
    @JoinColumn(name = "CONFIG_TABLE_HEADER_ID", referencedColumnName = "ID")
